...
router.post('/', permissionMiddleware('sales:create'), validate(saleSchema), saleController.createSale);
...
router.post('/:id/cancel', permissionMiddleware('sales:cancel'), validate(cancelSaleSchema), saleController.cancelSale);
